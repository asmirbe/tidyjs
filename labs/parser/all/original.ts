...
// Define DEFAULT_IMPORT_GROUPS directly in this file instead of importing from config
...
function getImportGroup(moduleName: string, DEFAULT_IMPORT_GROUPS: ImportGroup[]): string {
    ...
    const importGroup = DEFAULT_IMPORT_GROUPS.find((group) => group.regex.test(moduleName));
...
export function parseImports(
    ...
    const groups = DEFAULT_IMPORT_GROUPS.length > 0 ? DEFAULT_IMPORT_GROUPS : DEFAULT_IMPORT_GROUPS;
